...
import { simpleReducer, simpleIncrement, simpleDecrement } from './store/05-simple';
import { simple2Slice, simple2Increment, simple2Decrement } from './store/06-simple';
import { simpleAsyncReducer, asyncLoadAction } from './store/07-async';
import { asyncLoadAction2, asyncSlice2 } from './store/08-async';
